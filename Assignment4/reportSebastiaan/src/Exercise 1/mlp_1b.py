...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        self.mean_squared_error = self.hiddenLayer2.mean_squared_error
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=100,
   ...
   """
    ...
    # here symbolically
    cost = classifier.mean_squared_error(theano.tensor.reshape(y, [20,1],ndim=None))
